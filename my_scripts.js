...
function viewStudentStats(id, toggle){
	if(toggle == 0){
		document.getElementById(id).style.height = 0;//update to our new height
		document.getElementById(id).style.visibility = 'hidden';//update to our new height
	}else if(toggle == 1){
		document.getElementById(id).style.height = 'auto';//update to our new height
		document.getElementById(id).style.visibility = 'visible';//update to our new height
	}
}
